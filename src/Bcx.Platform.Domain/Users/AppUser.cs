...
namespace Bcx.Platform.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update PlatformDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update PlatformEfCoreEntityExtensionMappings to extend the IdentityUser entity
        ...
        /**
         * ATENÇÃO:::: NÃO USE ESSA REFERÊNCIA DE USER NO TEU PROJETO
         * VC VAI SE ARREPENDER!!!!
         * REFERENCIA DIRETO O IdentityUser
         * VAI NA FÉ
         */
